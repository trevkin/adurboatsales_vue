<template>
  <div class="w-full">
    ...
    <div v-masonry origin-left="true" transition-duration="1s" item-selector=".item" class="mx-0 pt-3 p-0 text-md block">
      <div v-masonry-tile
           v-if="boat.boatID"
    ...
    <div v-masonry origin-left="true" transition-duration="1s" item-selector=".item" class="m-0 p-0 text-md h-24 block">
